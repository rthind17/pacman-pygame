...
class Player:
    ...
    def update(self):
        ...
        #setting grid position reference to pixel position
    ...
    def draw(self):
        ...
        #pygame.draw.rect(self.app.screen, blue, 
    ...
    def on_mars(self):
        if self.grid_pos in self.app.mars:
    ...
    def eat_mars(self):
        self.app.mars.remove(self.grid_pos)
